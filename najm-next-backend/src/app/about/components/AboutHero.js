  ...
  const slides = [
    {
      ...
      title: 'عن شركتنا',
      subtitle: 'أكثر من 25 عاماً من التميز والاحترافية',
      description: 'نحن رائدون في مجال المقاولات والإنشاءات، نقدم أفضل الخدمات بأعلى معايير الجودة'
    },
    {
      image: '/images/about.jpg',
      title: 'رؤيتنا',
      subtitle: 'تحقيق التطلعات العمرانية',
      description: 'نسعى لأن نكون الخيار الأول لجميع العملاء في المنطقة'
    },
    {
      image: '/images/about.jpg',
      title: 'مهمتنا',
      subtitle: 'البناء بأمانة وإتقان',
      description: 'تقديم مشاريع بجودة عالية، في الوقت المناسب وبأسعار منافسة'
    },
  ];
